    ...
    public void resaltarZonasProhibidas() {
        for (int filas = 4; filas <= 5; filas++) {
            for (int columnas = 2; columnas <= 3; columnas++) {
                ...
                //fichas[filas][columnas].label.setBackground(new Color(255, 228, 22, 255));
                //fichas[filas][columnas].label.setBorder(BorderFactory.createLineBorder(new Color(255,228,22,255)));
                fichas[filas][columnas].label.repaint();
                
            }
            for (int columnas = 6; columnas <= 7; columnas++) {
                fichas[filas][columnas].label.setOpaque(false);
                //fichas[filas][columnas].label.setBackground(new Color(255, 0, 255, 255));
                //fichas[filas][columnas].label.setBorder(BorderFactory.createLineBorder(new Color(255,0,255,255)));
                fichas[filas][columnas].label.repaint();
            }
        }
    }
